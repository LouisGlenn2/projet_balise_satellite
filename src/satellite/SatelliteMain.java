...
public class SatelliteMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        balise1.setMoveStrategy(new HorizontalDroiteStrategy(500, 3, 0, LARGEUR_FENETRE));
        ...
        balise2.setMoveStrategy(new VerticalHautStrategy(200, 3, 400, 700));
        ...
        balise4.setMoveStrategy(new ImmobileStrategy(450, 600));
        ...
        balise5.setMoveStrategy(new HorizontalGaucheStrategy(650, 2, 0, LARGEUR_FENETRE));
